function varargout = testakim(varargin)
...
%      applied to the GUI before testakim_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to testakim_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 07-Oct-2020 21:00:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @testakim_OpeningFcn, ...
                   'gui_OutputFcn',  @testakim_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function testakim_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = testakim_OutputFcn(hObject, eventdata, handles) 
...
testgerilim; %akým kalibrasyonu uygulamasý açýlýr.
